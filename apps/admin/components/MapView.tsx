...
export default function MapView({ markers, height = '360px' }: { markers: MapMarker[]; height?: string }) {
  ...
  return (
    <div className="w-full overflow-hidden rounded-lg border" style={{ height }}>
      <MapContainerAny center={center} zoom={12} scrollWheelZoom className="h-full w-full">
        <TileLayerAny
